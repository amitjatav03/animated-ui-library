...
const Card = ({title, desc, children}) => {
  return (
    <div className='w-full md:w-[40%] lg:w-[30%] h-[27rem] hover:border-1 border-zinc-400 bg-white shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)] dark:bg-zinc-900 dark:shadow-none  rounded-lg flex flex-col p-4'>
